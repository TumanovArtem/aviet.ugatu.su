    ...
    <tr>
        <td valign="top" align="center">
            <table width="550" cellpadding="0" cellspacing="0">
                <tr>
                    <td>
                        <a href="https://gtmetrix.com/"><img src="https://static.gtmetrix.com/images/email-header.png" width="550" height="107" border="0" alt="Analyze your site at GTmetrix" /></a>
                    </td>
                </tr>
            </table>
...
HERE;
    ...
    public function hosting_meta_box() {
        ...
        <a href="https://www.gossamer-threads.com/hosting/wordpress.html" target="_blank" class="button-secondary">Get WordPress Optimized Hosting</a>
        <?php
    }
    ...
    public function test_meta_box() {
        ...
        <form method="post" id="gfw-parameters">
            ...
            <p><input type="text" id="gfw_url" name="gfw_url" value="<?php echo $passed_url; ?>" placeholder="You can enter a URL (eg https://yourdomain.com), or start typing the title of your page/post" /><br />
                <span class="gfw-placeholder-alternative description">You can enter a URL (eg https://yourdomain.com), or start typing the title of your page/post</span></p>
