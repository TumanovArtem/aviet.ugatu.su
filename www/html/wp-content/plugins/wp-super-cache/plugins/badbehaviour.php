...
function wp_supercache_badbehaviour_admin() {
	...
	?>
		...
		echo '<p>' . sprintf( __( '(Only legacy caching supported, disabled compression and requires <a href="https://www.bad-behavior.ioerror.us/">Bad Behavior</a> in "%s/plugins/bad-behavior/") ', 'wp-super-cache' ), WP_CONTENT_DIR ) . '</p>';
