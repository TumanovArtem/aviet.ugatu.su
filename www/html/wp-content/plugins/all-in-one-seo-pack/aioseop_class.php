...
class All_in_One_SEO_Pack extends All_in_One_SEO_Pack_Module {
	...
	function __construct() {
		...
		$this->help_text = array(
			...
			'ga_domain'                   => __( 'Enter your domain name without the https:// to set your cookie domain.', 'all-in-one-seo-pack' ),
			'ga_multi_domain'             => __( 'Use this option to enable tracking of multiple or additional domains.', 'all-in-one-seo-pack' ),
			'ga_addl_domains'             => __( 'Add a list of additional domains to track here.  Enter one domain name per line without the https://.', 'all-in-one-seo-pack' ),
