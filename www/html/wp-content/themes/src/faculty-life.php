<?php
/*
Template Name: Faculty-Life
*/
?>

<?php get_header("second"); ?>
<a data-name="what-anchor"></a>
<div class="info-block-back pb">
	<div class="info-block container">
		<div class="col-lg-6 col-sm-6 col-xs-12 about">
			<h1>ЧТО ТАКОЕ ПРОФБЮРО?</h1>
			<div class="about-wrapper pb-wrapper">
				<p>Профбюро – это профсоюзная организация студентов одного факультета (филиала). Состоит из председателя, его заместителя, комиссий, профоргов и активистов. На их плечи ложится проведение большинства культмассовых мероприятий и праздников. Стать членом профбюро своего факультета может каждый, кто активно участвует в общественной жизни.</p>
				<p>Профорг (профсоюзный организатор) – это студент, избранный в группе для представления ее интересов в профсоюзной организации.</p>
				<p>Его обязанности – разъяснять в группе задачи профкома и преимущества вступления в профсоюз, посещать собрания профоргов и доносить до студентов всю полученную там информацию, привлекать их к общественной жизни вуза, содействовать получению матпомощи и путевок. Если профорг группы не выполняет свои обязанности, его следует перевыбрать. Проявление инициативы и активная жизненная позиция приветствуются.</p>
			</div>
		</div>
		<div class="list col-lg-6 col-sm-6 hidden-xs">
		</div>
	</div>
</div>
<a data-name="active-anchor"></a>
<div class="citations-title-back">
	<div class="citations-title container">
		<h1>СОСТАВ ПРОФБЮРО</h1>
	</div>
</div>
	...
	<div class="citations container" data-slider="citations-xs">
		...
		<div class="citations-scroll col-xs-8">
			<div class="citations-lg-wrapper hidden-lg fadeIn" data-slider-info="citations-lg" data-slider-number="0">
				<div class="cit colm-lg-4 hidden-xs citations-xs-wrapper fadeIn wow" data-slider-info="citations-xs" data-slider-number="0" data-modal-button="http://aviet.ugatu.su/predsedatel-profbyuro/">
					<div class="avatar"><img src="http://aviet.ugatu.su/wp-content/themes/aviet/img/galimova.png" alt=""></div>
					<h2>ГАЛИМОВА ДИАНА</h2>
					<em>ПРЕДСЕДАТЕЛЬ ПРОФБЮРО</em>
					<blockquote></blockquote>
				</div>
				<div class="cit colm-lg-4 hidden-xs citations-xs-wrapper fadeIn wow" data-slider-info="citations-xs" data-slider-number="1" data-modal-button="http://aviet.ugatu.su/zamestitel-po-obshhim-voprosam/">
					<div class="avatar"><img src="http://aviet.ugatu.su/wp-content/themes/aviet/img/satinaev.png" alt=""></div>
					<h2>САТИНАЕВ АЛЕКСЕЙ</h2>
					<em>ЗАМЕСТИТЕЛЬ ПО ОБЩИМ ВОПРОСАМ</em>
					<blockquote></blockquote>
				</div>
				<div class="cit colm-lg-4 hidden-xs citations-xs-wrapper fadeIn wow" data-slider-info="citations-xs" data-slider-number="2" data-modal-button="http://aviet.ugatu.su/zamestitel-po-sotsialno-pravovoy-pomoshhi-studentam/">
					<div class="avatar"><img src="http://aviet.ugatu.su/wp-content/themes/aviet/img/egibaev.png" alt=""></div>
					<h2>ИГЕБАЕВ АЗАТ</h2>
			...
			<div class="citations-lg-wrapper hidden-lg fadeIn" data-slider-info="citations-lg" data-slider-number="1">
				<div class="cit colm-lg-4 hidden-xs citations-xs-wrapper fadeIn wow" data-slider-info="citations-xs" data-slider-number="3" data-modal-button="http://aviet.ugatu.su/nauchnaya-komissiya-2/">
					<div class="avatar"><img src="http://aviet.ugatu.su/wp-content/themes/aviet/img/ermolaev.png" alt=""></div>
				...
				<div class="cit colm-lg-4 hidden-xs citations-xs-wrapper fadeIn wow" data-slider-info="citations-xs" data-slider-number="4" data-modal-button="http://aviet.ugatu.su/sportivnaya-komissiya">
					<div class="avatar"><img src="http://aviet.ugatu.su/wp-content/themes/aviet/img/zaidullina.png" alt=""></div>
				...
				<div class="cit colm-lg-4 hidden-xs citations-xs-wrapper fadeIn wow" data-slider-info="citations-xs" data-slider-number="5" data-modal-button="http://aviet.ugatu.su/kultmassovaya-komissiya/">
					<div class="avatar"><img src="http://aviet.ugatu.su/wp-content/themes/aviet/img/nugmanova.png" alt=""></div>
			...
			<div class="citations-lg-wrapper hidden-lg fadeIn" data-slider-info="citations-lg" data-slider-number="2">
				<div class="cit colm-lg-4 hidden-xs citations-xs-wrapper fadeIn wow" data-slider-info="citations-xs" data-slider-number="6" data-modal-button="http://aviet.ugatu.su/ozdorovitelnaya-komissiya/">
					<div class="avatar"><img src="http://aviet.ugatu.su/wp-content/themes/aviet/img/allayarova.png" alt=""></div>
				...
				<div class="cit colm-lg-4 hidden-xs citations-xs-wrapper fadeIn wow" data-slider-info="citations-xs" data-slider-number="7" data-modal-button="http://aviet.ugatu.su/informatsionnaya-komissiya/">
					<div class="avatar"><img src="http://aviet.ugatu.su/wp-content/themes/aviet/img/davletova.png" alt=""></div>
				...
				<div class="cit colm-lg-4 hidden-xs citations-xs-wrapper fadeIn wow" data-slider-info="citations-xs" data-slider-number="8" data-modal-button="http://aviet.ugatu.su/sotsialnaya-komissiya/">
					<div class="avatar"><img src="http://aviet.ugatu.su/wp-content/themes/aviet/img/mashtarieva.png" alt=""></div>
...
<div class="news-back" style="display: none;">
	<div class="news container">
		<h1>ЛЕТО В УГАТУ</h1>
		<div class="news-wrapper container" data-cat="11">
			<?php
				global $post;
...
<a data-name="event-anchor"></a>
<div class="news-back">
	<div class="news container">
		<h1>МЕРОПРИЯТИЯ</h1>
		<div class="news-wrapper container" data-cat="12">
			<?php
				global $post;
				...
				?>
				<?php if (  $q->max_num_pages > 1 ) { ?>
					<a class="load-more" data-page="1" data-max-page="<?php echo $q->max_num_pages; ?>">ПОКАЗАТЬ ВСЕ</a>
				<?php
				}
			wp_reset_postdata();
			?>
...
<a data-name="galery-anchor"></a>
<div class="galery-back">
	<div class="container galery">
		<h1>ГАЛЕРЕЯ</h1>
		<div class="galery-wrapper" data-cat="9">
...
<a data-name="video-anchor"></a>
<div class="video-back">
	<div class="video container">
		<h1>ВИДЕО</h1>
		<div class="video-wrapper" data-cat="10">
				<?php
				global $post;
...
<script src="http://aviet.ugatu.su/wp-content/themes/aviet/js/accordion.js"></script>
<script>
	'use strict'
	document.addEventListener("DOMContentLoaded", postAutoDelay(document.querySelectorAll(".citations-lg-wrapper")));
	$('<link rel="stylesheet" href="http://aviet.ugatu.su/wp-content/themes/aviet/css/all.css"><link rel="stylesheet" href="http://aviet.ugatu.su/wp-content/themes/aviet/css/faculty-life.css">').appendTo($("head"));
