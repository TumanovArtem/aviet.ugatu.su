...
<header class="main-header-back">
	<div class="container main-header">
		...
		<div class="title">ФАКУЛЬТЕТ АВИОНИКИ, ЭНЕРГЕТИКИ<br> И ИНФОКОММУНИКАЦИЙ</div>
	</div>
</header>
<div class="BSMU-USATU"><i class="icon"></i>Сайт совместной межвузовской лаборатории медицинских и технических специалистов. БГМУ и УГАТУ вместе!</div>