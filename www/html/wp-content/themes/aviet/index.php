...
<div class="news-back">
	<div class="news container" data-slider="news">
		...
		<div class="trigger-sm hidden-lg hidden-xs ">
			<span>ТЭГИ</span>
			<div>
				<img src="https://aviet-ugatu.herokuapp.com/wp-content/themes/aviet/img/arrow-down.png" alt="" class="" width="13" height="13">
...
<div class="galery-back">
	<div class="galery container ">
		...
		<a href="https://aviet-ugatu.herokuapp.com/faculty-life#gallery-anchor" class="button hidden-lg wow fadeIn">В ГАЛЕРЕЮ</a>
	</div>
</div>
		...
		<div class="citations-scroll col-xs-8">
			<div class="citations-lg-wrapper hidden-lg fadeIn" data-slider-info="citations-lg" data-slider-number="0">
				<div class="cit colm-lg-4 hidden-xs citations-xs-wrapper fadeIn wow" data-slider-info="citations-xs" data-slider-number="0">
					<div class="avatar"><img width="50" height="50" src="https://aviet-ugatu.herokuapp.com/wp-content/themes/aviet/img/zhernakov.png" alt=""></div>
				...
				<div class="cit colm-lg-4 hidden-xs citations-xs-wrapper fadeIn wow" data-slider-info="citations-xs" data-slider-number="1">
					<div class="avatar"><img width="50" height="50" src="https://aviet-ugatu.herokuapp.com/wp-content/themes/aviet/img/lobanov2.png" alt=""></div>
				...
				<div class="cit colm-lg-4 hidden-xs citations-xs-wrapper fadeIn wow" data-slider-info="citations-xs" data-slider-number="2">
					<div class="avatar"><img width="50" height="50" src="https://aviet-ugatu.herokuapp.com/wp-content/themes/aviet/img/urazbahtina.png" alt=""></div>
			...
			<div class="citations-lg-wrapper hidden-lg fadeIn" data-slider-info="citations-lg" data-slider-number="1">
				<div class="cit colm-lg-4 hidden-xs citations-xs-wrapper fadeIn wow" data-slider-info="citations-xs" data-slider-number="3">
					<div class="avatar"><img width="50" height="50" src="https://aviet-ugatu.herokuapp.com/wp-content/themes/aviet/img/bagmanov.png" alt=""></div>
				...
				<div class="cit colm-lg-4 hidden-xs citations-xs-wrapper fadeIn wow" data-slider-info="citations-xs" data-slider-number="4">
					<div class="avatar"><img width="50" height="50" src="https://aviet-ugatu.herokuapp.com/wp-content/themes/aviet/img/phetisov.png" alt=""></div>
				...
				<div class="cit colm-lg-4 hidden-xs citations-xs-wrapper fadeIn wow" data-slider-info="citations-xs" data-slider-number="5">
					<div class="avatar"><img width="50" height="50" src="https://aviet-ugatu.herokuapp.com/wp-content/themes/aviet/img/mukaev.png" alt=""></div>
			...
			<div class="citations-lg-wrapper hidden-lg fadeIn" data-slider-info="citations-lg" data-slider-number="2">
				<div class="cit colm-lg-4 hidden-xs citations-xs-wrapper fadeIn wow" data-slider-info="citations-xs" data-slider-number="6">
					<div class="avatar"><img width="50" height="50" src="https://aviet-ugatu.herokuapp.com/wp-content/themes/aviet/img/roginskaya.png" alt=""></div>
				...
				<div class="cit colm-lg-4 hidden-xs citations-xs-wrapper fadeIn wow" data-slider-info="citations-xs" data-slider-number="7">
					<div class="avatar"><img width="50" height="50" src="https://aviet-ugatu.herokuapp.com/wp-content/themes/aviet/img/sattarov.png" alt=""></div>
				...
				<div class="cit colm-lg-4 hidden-xs citations-xs-wrapper fadeIn wow" data-slider-info="citations-xs" data-slider-number="8">
					<div class="avatar"><img width="50" height="50" src="https://aviet-ugatu.herokuapp.com/wp-content/themes/aviet/img/pashali.png" alt=""></div>
...
<script>
	...
	jQuery('<link rel="stylesheet" href="https://aviet-ugatu.herokuapp.com/wp-content/themes/aviet/css/all.min.css"><link rel="stylesheet" href="https://aviet-ugatu.herokuapp.com/wp-content/themes/aviet/css/main.min.css">').appendTo(jQuery("head"));
</script>
</body>
</html>